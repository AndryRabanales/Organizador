                    ...
                    <div className={clsx("glass-panel p-1 relative select-none transition-all duration-500 mx-auto max-w-6xl mb-16")}>
                        ...
                        <div className="overflow-x-auto relative z-10">
                            <table className="w-full text-sm border-collapse">
                                <thead>
                                    <tr>
                                        <th className="py-2 pr-2 pl-8 text-left w-24 text-slate-500 font-mono text-xs bg-slate-900/50 backdrop-blur">TIME</th>
                                        {DAYS.map((day, index) => (
                                            <th key={day} className={clsx(
                                                "p-2 text-center font-bold border-b w-[12%] backdrop-blur transition-colors",
                                                index === appDay
                                ...
                                <tbody>
                                    {slots.map((slot, rowIndex) => (
                                        <tr key={rowIndex} className="border-b border-slate-800/50 hover:bg-slate-800/30 transition-colors h-8">
                                            <td className="py-2 pr-2 pl-8 text-slate-500 font-mono text-xs border-r border-slate-800 relative group/time">
                                                {slot.label}
                                            </td>
                                            {DAYS.map((_, colIndex) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {labelObj && (
                                                            ...
                                                            >
                                                                <span className="text-[10px] uppercase font-bold tracking-tighter opacity-70 truncate px-1 flex-1" style={{ color: labelObj.color }}>
                                                                    {labelObj.name}
                                                                </span>
